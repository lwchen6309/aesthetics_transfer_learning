...
class CombinedModel(nn.Module):
    ...
    def forward(self, images, traits_histogram):
        ...
        attribute_logits = self.gap(attribute_logits)[:,:,0,0]
        aesthetic_logits = self.gap(aesthetic_logits)[:,:,0,0]
...
if __name__ == '__main__':
    ...
    if is_log:
        ...
        wandb.init(project="resnet_PARA_PIAA", tags=hyperparam_tags, notes="attr_nopt_gap")
    ...
    best_model = None
    best_modelname = 'best_model_resnet50_histo_attr_nopt_gap_lr%1.0e_decay_%depoch' % (lr, num_epochs)
