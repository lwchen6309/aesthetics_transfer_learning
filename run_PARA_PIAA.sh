...
python "$run_script" $trainparams --backbone swin_tiny_patch4_window7_224 --resume models_pth/best_model_swin_tiny_patch4_window7_224_piaamir_jumping-wildflower-1167.pth
