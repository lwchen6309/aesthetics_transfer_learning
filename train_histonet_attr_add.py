...
class CombinedModel(nn.Module):
    ...
    def forward(self, images, traits_histogram):
        ...
        attribute_logits = self.fc_attribute(x + self.pt_encoder(traits_histogram))
...
if __name__ == '__main__':
    ...
    if is_log:
        ...
        wandb.init(project="resnet_PARA_PIAA", tags=hyperparam_tags, notes="attr_addition")
    ...
    best_model = None
    best_modelname = 'best_model_resnet50_histo_attr_add_lr%1.0e_decay_%depoch' % (lr, num_epochs)
