...
from PARA_PIAA_dataloader import PARA_PIAADataset, collect_batch_attribute, collect_batch_personal_trait, split_dataset_by_user, split_dataset_by_images, limit_annotations_per_user, split_dataset_by_trait
import wandb
...
def load_data(root_dir = '/home/lwchen/datasets/PARA/', trait=None, value=None):
    ...
    if trait is not None and value is not None:
        # train_dataset = split_dataset_by_trait(train_piaa_dataset, trait, value)
        # test_dataset = split_dataset_by_trait(test_piaa_dataset, trait, value)
...
if __name__ == '__main__':
    ...
    train_dataset, test_dataset = load_data(trait=args.trait, value=args.value)
    n_workers = 4
    ...
    for epoch in range(num_epochs):
        ...
        if is_log:
            ...
            wandb.log({"Test PIAA SROCC": test_srocc}, commit=True)
