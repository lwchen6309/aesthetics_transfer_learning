...
# python $run_script --trainset GIAA
python $run_script --trainset sGIAA-pair --batch_size 50

python $run_script --n_fold 4 --fold_id 1 --use_cv --trainset sGIAA-pair --batch_size 50
python $run_script --n_fold 4 --fold_id 2 --use_cv --trainset sGIAA-pair --batch_size 50
python $run_script --n_fold 4 --fold_id 3 --use_cv --trainset sGIAA-pair --batch_size 50
python $run_script --n_fold 4 --fold_id 4 --use_cv --trainset sGIAA-pair --batch_size 50
