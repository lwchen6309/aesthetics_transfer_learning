...
from PARA_histogram_dataloader import load_usersplit_data, PARA_MIAA_HistogramDataset, PARA_GIAA_HistogramDataset, PARA_PIAA_HistogramDataset, PARA_PIAA_HistogramDataset_Precomputed
...
def load_data(root_dir = '/home/lwchen/datasets/PARA/', method = 'pacmap', dims = 2, num_user = 200, is_reverse=False):
    ...
    train_dataset = PARA_PIAA_HistogramDataset_Precomputed(root_dir, transform=train_transform, data=train_dataset.data)
