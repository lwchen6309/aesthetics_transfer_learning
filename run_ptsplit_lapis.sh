...
#     python $run_script --trait demo_gender --value $value --dropout 0.5
# done

# list=("primary education" "secondary education" "Bachelor's or equivalent" "Master's or equivalent" "Doctorate")
# for value in "${list[@]}"; do
#     python $run_script --trait demo_edu --value "$value" --dropout 0.5
# done
