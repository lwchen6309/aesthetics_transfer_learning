...
if __name__ == '__main__':
    ...
    best_model = None
    best_modelname = 'best_model_resnet50_llbhn_lr%1.0e_%depoch' % (lr, num_epochs)
    if not use_attr:
    ...
    for epoch in range(num_epochs):
        ...
        test_mse_loss, test_mse_std_loss, test_custom_loss, test_ce_loss, test_raw_ce_loss, test_emd_loss, dropout_mean, dropout_std = evaluate(
            model_resnet50, test_dataloader, criterion, ce_weight, device, num_samples=10)
        if is_log:
            wandb.log({
