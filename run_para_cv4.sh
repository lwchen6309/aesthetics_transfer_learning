# python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 1 --trainset GIAA
# python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 2 --trainset GIAA
# python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 3 --trainset GIAA
# python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 4 --trainset GIAA

python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 1 --trainset PIAA
python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 2 --trainset PIAA
python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 3 --trainset PIAA
python train_histonet_latefusion.py --use_cv --n_fold 4 --fold_id 4 --trainset PIAA
