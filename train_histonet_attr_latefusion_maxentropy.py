...
from PARA_histogram_dataloader import PARA_GIAA_HistogramDataset, PARA_PIAA_HistogramDataset, PARA_sGIAA_HistogramDataset
...
def optimize_entropy_for_batch(distributions, lr=0.1, num_sample=30, num_epochs=1):
...
def train(model, dataloader, criterion, optimizer, device):
    ...
    for sample in progress_bar:
        ...
        optimizer.zero_grad()
        aesthetic_logits, attribute_logits = model(images, total_traits_histogram)
