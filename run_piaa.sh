...
python train_piaa_mir_usersample.py --no_log --max_annotations_per_user 10 --batch_size 50 --model PIAA_ICI --disable_onehot --num_users 500 --pretrained_model $giaa_pretrain
python train_piaa_mir_usersample.py --no_log --max_annotations_per_user 10 --batch_size 100 --model PIAA_MIR --disable_onehot --num_users 500 --pretrained_model $giaa_pretrain
