...
python train_piaa_mir_lapis.py --pretrained_model models_pth/best_model_resnet50_nima_attr_lr5e-05_decay_20epoch_swept-energy-251.pth --num_epochs 2 --lr 5e-4
python train_piaa_mir_lapis.py --pretrained_model models_pth/best_model_resnet50_nima_attr_lr5e-05_decay_20epoch_swept-energy-251.pth --num_epochs 2 --lr 5e-3
