...
python train_piaa_mir_usersample.py --no_log --batch_size 50 --model PIAA_ICI --disable_onehot --num_users 3 --pretrained_model models_pth/best_model_resnet50_nima_attr_lr5e-05_decay_20epoch_swept-energy-251.pth
