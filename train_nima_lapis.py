...
def load_data(root_dir = '/home/lwchen/datasets/LAPIS', fold_id=1, n_fold=4):
    ...
    # test_piaa_imgsort_dataset = LAPIS_PIAA_HistogramDataset_imgsort(root_dir, transform=test_transform, data=test_lavis_piaa_dataset.data, map_file=os.path.join(pkl_dir,'testset_image_dct_%dfold.pkl'%fold_id), precompute_file=os.path.join(pkl_dir,'testset_GIAA_dct_%dfold.pkl'%fold_id))
...
num_pt = 132
resume = None
resume = 'models_pth/lapis_best_model_resnet50_nima_lr5e-05_decay_20epoch_toasty-plasma-170.pth'
